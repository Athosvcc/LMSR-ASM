...
public class Stock extends Asset implements CustomProbeable, DescriptorContainer   {
   ...
   public Stock() { // constructor to initialize different value processes
      Hashtable h1 = new Hashtable();
      h1.put(new Integer(Stock.OUP), "Ohrnst.-Uhlenbeck");
      h1.put(new Integer(Stock.RANDOMWALK), "Random Walk");
      h1.put(new Integer(Stock.CONSTANT),"Const. Dividend");
      h1.put(new Integer(Stock.SQUARE),"Square Wave");
      h1.put(new Integer(Stock.TRIANGULAR),"Triangular Wave");
      h1.put(new Integer(Stock.SINUS),"Sinus Wave");
